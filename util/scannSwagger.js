...
async function getApisFromSwaggerFile() {
  const { ENDPOINT_SWAGGER_PAGE, ENDPOINT_SCANN_SWAGGER_FROM } =
  ...
  console.log("ENDPOINT_SCANN_SWAGGER_FROM :", ENDPOINT_SCANN_SWAGGER_FROM);
...
async function getTokenServiceFromCurl() {
  ...
  console.log("ENDPOINT_GET_TOKEN:  ", ENDPOINT_GET_TOKEN);
  ...
  try {
    console.log(resultOfExec);

    // try {
    //   if(JSON.parse(resultOfExec.stdout).include("token")){
    //     results = JSON.parse(resultOfExec.stdout)["token"];
    //   } else {
    //     results = JSON.parse(resultOfExec.stdout)
    //   }
    // } catch (error) {
    //   log.warn(error.message)
    //   if(JSON.parse(resultOfExec.stdout).include("token")){
    //     results =resultOfExec.stdout["token"];
    //   } else {
    //     results = resultOfExec.stdout
    //   }
    // }
    results = resultOfExec.stdout;
