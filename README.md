...
Smoke Testing: 
====================
It is a service developed to avoid sporadic failures in development environments. The service performs verifications of environments composed of micro-services. It is a great alternative to remediate flaky failures that cause wasted time in stages of development.
...
* [Smoke Test Coverage](#smoke-test-coverage) 
* [How use the service with Docker](#how-use-the-service-with-docker)
	* [Run service](#run-service)
	* [Run example of smoke testing](#markdown-header-emphasis)
		* [Case: Pase Test](#case:-pase-test)
* [Use of Enviroment variable in Smoke testing](#use-of-enviroment-variable-in-smoke-testing])
	* [General settings](#general-settings)
	* [Criterial settings](#criterial-settings)
...
It is necessary for this example suite to create one file with the name docker-compose.yml
...
This example recreates a stability problem in the absence of the database. The smoke testing service finds the fault.

#### 2) Run example_2 using docker-compose.yml (failure case)
...
## Use of Environment variables in Smoke testing
